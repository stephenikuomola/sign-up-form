...
})({"lY6OU":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "89648abc22141595";
"use strict";
...
},{}],"1Gxkx":[function(require,module,exports) {
...
class FirstName {
    ...
    static showErrorMessageAndIndicator() {
        if (FirstName.input.validity.valueMissing || FirstName.input.value.trim() === "") FirstName.errorMessage.textContent = "First Name cannot be empty";
        if (FirstName.input.validity.patternMismatch) FirstName.errorMessage.textContent = "First Name must be between 1 and 20 characters";
        FirstName.input.className = "error";
        FirstName.input.nextElementSibling.className = "icon-error__show";
    }
    static checkInputValidity() {
        if (FirstName.valid()) FirstName.resetErrorMessageAndIndicator();
        else FirstName.showErrorMessageAndIndicator();
    }
}
class LastName {
    ...
    static showErrorMessageAndIndicator() {
        if (LastName.input.validity.valueMissing || LastName.input.value.trim() === "") LastName.errorMessage.textContent = "Last Name cannot be empty";
        if (LastName.input.validity.patternMismatch) LastName.errorMessage.textContent = "Last Name must be between 1 and 20 characters";
        LastName.input.className = "error";
        LastName.input.nextElementSibling.className = "icon-error__show";
    }
    static checkInputValidity() {
        if (LastName.valid()) LastName.resetErrorMessageAndIndicator();
        else LastName.showErrorMessageAndIndicator();
    }
}
class Email {
    ...
    static showErrorMessageAndIndicator() {
        if (Email.input.validity.valueMissing) Email.errorMessage.textContent = "Email cannot be empty";
    ...
    static checkInputValidity() {
        if (Email.input.checkValidity()) Email.resetErrorMessageAndIndicator();
        else Email.showErrorMessageAndIndicator();
    }
}
class Password {
    ...
    static showErrorMessageAndIndicator() {
        if (Password.input.validity.valueMissing || Password.input.value.trim() === "") Password.errorMessage.textContent = "Password cannot be empty";
        if (Password.input.validity.tooShort) Password.errorMessage.textContent = "Password must be at least 7 characters long";
        Password.input.className = "error";
        Password.input.nextElementSibling.className = "icon-error__show";
    }
    static checkInputValidity() {
        if (Password.valid()) Password.resetErrorMessageAndIndicator();
        else Password.showErrorMessageAndIndicator();
    }
}
new FormComponent();

},{}]},["lY6OU","1Gxkx"], "1Gxkx", "parcelRequire47f7")

//# sourceMappingURL=index.22141595.js.map
