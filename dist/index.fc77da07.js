...
})({"9Wc5R":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "4f0ed252fc77da07";
"use strict";
...
},{}],"5xE2P":[function(require,module,exports) {
...
class FormComponent {
    ...
    #submitForm(evtObj1) {
        this.#checkFirstNameValidity(evtObj1);
        this.#checkLastNameValidity(evtObj1);
        this.#checkEmailValidity(evtObj1);
        this.#checkPasswordValidity(evtObj1);
    }
    #checkPasswordValidity(evtObj2) {
        if (this.#password.validity.valueMissing || this.#password.value.trim() === "") {
            evtObj2.preventDefault();
        ...
        } else this.#resetErrorMessageAndIndicator(this.#password, "");
    }
    #checkEmailValidity(evtObj3) {
        if (this.#email.validity.valid) this.#resetErrorMessageAndIndicator(this.#email, "");
        if (this.#email.validity.valueMissing) {
            evtObj3.preventDefault();
    ...
    #checkFirstNameValidity(evtObj4) {
        ...
        } else this.#resetErrorMessageAndIndicator(this.#firstName, "");
    }
    #checkLastNameValidity(evtObj5) {
        if (this.#lastName.validity.valueMissing || this.#lastName.value.trim() === "") {
            evtObj5.preventDefault();
        ...
        } else this.#resetErrorMessageAndIndicator(this.#lastName, "");
    }
    ...
    #resetErrorMessageAndIndicator(input1, message1) {
        input1.nextElementSibling.nextElementSibling.textContent = message1;
        input1.className = "";
        input1.nextElementSibling.className = "icon-error__hide";
    }
}
new FormComponent();

},{}]},["9Wc5R","5xE2P"], "5xE2P", "parcelRequire47f7")

//# sourceMappingURL=index.fc77da07.js.map
